            ...
            <div class="tm-right-column">
                ...
                <div class="tm-content-div">
                    ...
                    <section id="welcome" class="tm-section">
                        <header>
                            <h2 class="tm-blue-text tm-welcome-title tm-margin-b-45">@lang('main.welcome')</h2>
                        </header>
                        <p>@lang('main.food is')</p>
                        <p>@lang('main.its the taste')</p>
                        <p>@lang('main.its precious moment')</p>
                        <p>@lang('main.and Im')</p>
                        <p>@lang('main.enjoy')</p>
                    </section>
                    <!-- About section -->
                    ...
                    <section id="contact" class="tm-section">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form method="post" action="/contact/check" class="contact-form">
                                    @csrf
